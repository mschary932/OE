/*
 * Controller class for frmMeasurementExecutionKA
 ...
 * @class frmMeasurementExecutionKAController
 * @param {Object} applicationContext - Application Context.
 * @param {Object} config - Config Object.
 */
kony.sdk.mvvm.frmMeasurementExecutionKAController = Class(kony.sdk.mvvm.BaseFormController, {
     ...
     * @memberof frmMeasurementExecutionKAController#
     */
    fetchData: function() {
    ...
    performAction: function(actionName, argsArray) {
        if( Object.keys(kony.servicesapp.swipedIndices).length>0){
			...
			animObj["callbacks"]={"animationEnd":function(){ 
					...
					return controller.$class.$superp.performAction.call(controller, actionName, argsArray);
				}
			}
		...
		else if(kony.servicesapp.isAnimationInProgress){return;}
        else{return this.$class.$superp.performAction.call(this, actionName, argsArray);}
    },
    /** 
