/*
 * Model Extension class for ObjectBOM object under ObjectBOM object service group
...
kony.sdk.mvvm.ObjectServices.ObjectBOM = kony.sdk.mvvm.ObjectServices.ObjectBOM || {};
/**
 * Creates a new Model Extension.
 * @class ObjectBOMModelExtension
 * @param {Object} modelObj - Model.
 */
kony.sdk.mvvm.ObjectServices.ObjectBOM.ObjectBOMModelExtension = Class({
     ...
     * @memberof ObjectBOMModelExtension#
