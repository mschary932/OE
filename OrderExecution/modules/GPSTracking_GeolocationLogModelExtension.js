/*
 * Model Extension class for GeolocationLog object under GPSTracking object service group
...
kony.sdk.mvvm.ObjectServices.GPSTracking = kony.sdk.mvvm.ObjectServices.GPSTracking || {};
/**
 * Creates a new Model Extension.
 * @class GeolocationLogModelExtension
 * @param {Object} modelObj - Model.
 */
kony.sdk.mvvm.ObjectServices.GPSTracking.GeolocationLogModelExtension = Class({
     ...
     * @memberof GeolocationLogModelExtension#
