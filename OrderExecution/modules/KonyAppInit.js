...
kony.sdk.mvvm.appInit = function(appContext) {
    try {
		...
		kony.servicesapp.WATCHPOSITIONCALLEDFIRSTTIME = true;
          ...
          kony.servicesapp.initialise_segment_pan_defaultValues(frmOrderResourcesListKA.segSwipeKA,kony.servicesapp.orderResourcesPanGestureHandler);
		  frmOrderResourcesListKA.segSwipeKA.editStyle = constants.SEGUI_EDITING_STYLE_SWIPE;
        }
		...
		kony.servicesapp.initialise_segment_pan_defaultValues(frmTimeAndExpenseKA.SegTimeExpenseKA, kony.servicesapp.timeAndExpensePanGestureHandlerKA);
		frmTimeAndExpenseKA.SegTimeExpenseKA.editStyle = constants.SEGUI_EDITING_STYLE_SWIPE;
        kony.servicesapp.initialise_segment_pan_defaultValues(frmMeasurementExecutionKA.segMeasurementKA, kony.servicesapp.measurementExecutionPanGestureHandlerKA);
		frmMeasurementExecutionKA.segMeasurementKA.editStyle = constants.SEGUI_EDITING_STYLE_SWIPE;        
        kony.servicesapp.initialise_segment_pan_defaultValues(frmMeasurementReadings.segSwipeKA, kony.servicesapp.measurementReadingsPanGestureHandlerKA);
		frmMeasurementReadings.segSwipeKA.editStyle = constants.SEGUI_EDITING_STYLE_SWIPE;

        // kony.servicesapp.initialise_segment_pan_defaultValues(frmStockLocationListKA.segSwipeKA, kony.servicesapp.stockLocationsPanGestureHandlerKA);
        // frmStockLocationListKA.segSwipeKA.editStyle = constants.SEGUI_EDITING_STYLE_SWIPE;     
...
kony.servicesapp.showFormOrderList = function() {
    ...
    frmTimeAndExpenseKA.flexSearchKA.tbxSearchKA.onCancel=function(){
        var controller = kony.sdk.mvvm.KonyApplicationContext.getAppInstance().getFormController("frmTimeAndExpenseKA");
        var appContext = controller.getApplicationContext();
        var TimeAndExpenseControllerExtension = appContext.getFormController("frmTimeAndExpenseKA").getControllerExtensionObject();
        TimeAndExpenseControllerExtension.setFormModelInfo("searchData",{});
        TimeAndExpenseControllerExtension.ClearSearch(true);
    };
  	frmMeasurementsKA.flxSearchKA.tbxSearchKA.onCancel=function(){
        var controller = kony.sdk.mvvm.KonyApplicationContext.getAppInstance().getFormController("frmMeasurementsKA");
        var appContext = controller.getApplicationContext();
        var MeasurementsControllerExtension = appContext.getFormController("frmMeasurementsKA").getControllerExtensionObject();
        MeasurementsControllerExtension.setFormModelInfo("searchData",{});
        MeasurementsControllerExtension.applyView(true);
    };
	kony.servicesapp.initialise_segment_pan_defaultValues(frmTaskExecutionKA.segSwipeKA,kony.servicesapp.resourcesPanGestureHandler);
	frmTaskResourcesListKA.segSwipeKA.editStyle = constants.SEGUI_EDITING_STYLE_SWIPE;
...
kony.servicesapp.showPendingOrderListKA = function(){
    try {
        ...
        hamburgerMenu.IS_ANIMATION_INPROGRESS = false;
        TAG.NC.initTransitions();
      	kony.servicesapp.syncPendingOrdersKA();
    	var appContext = kony.sdk.mvvm.KonyApplicationContext.getAppInstance();
