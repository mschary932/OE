...
kony.sdk.mvvm.frmDescriptionDetailsKAControllerExtension = Class(kony.sdk.mvvm.CustomFormControllerExtension, {
    ...
    bindData: function(dataMap) {
        try {
            var descDetails = this.getFormModelInfo("descDetails");
