...
kony.sdk.mvvm.AppGenUtils = Class({
    $statics: {
        ...
        HamMenu: {
            Hide: function(konyFormInstance) {
                ...
                function hideEndCallBack() {
                    konyFormInstance.FlexContainerHamMenu.left = "-60%";
        ...
        onHideForm: function(konyFormInstance) {
            if (konyFormInstance.FlexContainerMain.left !== 0) this.HamMenu.Hide(konyFormInstance)
        },
        BusinessLogicGen: {
        ...
        format: {
            segmentData: function(data, widgetConfig) {
                ...
                if (widgetConfig && widgetConfig.isGroupByDefined()) {
                    ...
                    if (data && data.length) if (!data[0].hasOwnProperty(groupByField)) throw kony.sdk.mvvm.KonyApplicationContext.getFactorySharedInstance().createExceptionObject(kony.sdk.mvvm.ExceptionCode.CD_INVALID_GROUPBYKEY, kony.sdk.mvvm.ExceptionCode.MSG_INVALID_GROUPBYKEY);
                    if (groupByField) {
...
kony.sdk.mvvm.AppFactoryInterface = Class({
    ...
    createGroupWidgetsContext: function(config, contextData) {},
...
kony.sdk.mvvm.AppFactoryMFAPP = Class(kony.sdk.mvvm.AppFactoryInterface, {
    ...
    createGroupWidgetsContext: function(config, contextData) {
        return new kony.sdk.mvvm.persistent.GroupWidgetsContext(config, contextData)
    },
    createMetadataStore: function() {
        ...
        try {
            ...
            for (var widgetId in this.konyWidgetObjects) {
                if (this.konyWidgetObjects[widgetId]) {
                    this.konyWidgetObjects[widgetId].destroy()
                }
            }
    ...
    return {
        $statics: {
            ...
            logout: function(logoutSucCallback, logoutErrCallback) {
                getApplicationContextImpl().logout(logoutSucCallback, logoutErrCallback)
            },
...
kony.sdk.mvvm.KonyApplicationContextMFAPP = Class(function() {
    ...
    return {
        $statics: {
            ...
            isAppsFirstLogin: function(params) {
                ...
                if (credStore !== null && credStore !== undefined) {
                    ...
                    var storedAppType = credStore[kony.sdk.mvvm.credStoreAppType];
                    ...
                    if (storedUsername !== undefined && storedAppType !== undefined && storedOptions !== undefined && kony.sdk.mvvm.Utils.matchIgnoreCase(storedUsername, username) && kony.sdk.mvvm.Utils.matchIgnoreCase(storedOptions.access, options.access) && kony.sdk.mvvm.Utils.matchIgnoreCase(storedAppType, apptype) && kony.sdk.mvvm.Utils.matchIgnoreCase(storedIdentityServiceName, identityServiceName)) {
                        return false
                    }
                }
                return true
            ...
            getRecentlyLoggedUserDetails: function() {
                ...
                if (credStore !== null && credStore !== undefined) {
                    ...
                    var storedAppType = credStore[kony.sdk.mvvm.credStoreAppType];
                    var storedUsername = credStore[kony.sdk.mvvm.credStoreUsername];
                    if (storedUsername !== undefined && storedOptions !== undefined && storedAppType !== undefined) {
                        userDetails["username"] = storedUsername;
                        userDetails["options"] = storedOptions;
                        userDetails["APPTYPE"] = storedAppType
                    }
                }
                return userDetails
            },
            ...
            appServicesLogin: function(params, loginSuccessCallback, loginErrorCallback) {
                try {
                    ...
                    authParams["APPTYPE"] = params["APPTYPE"];
                    authParams["options"] = params["options"];
                    authParams["identityServiceName"] = params["identityServiceName"];
            ...
            getObjectService: function(options, objectServiceName) {
                try {
                    var optionsKey = options["access"];
                    var objectService = kony.sdk.mvvm.KonyApplicationContextMFAPP.OBJECT_SERVICES[optionsKey][objectServiceName];
                    if (!objectService) {
                        objectService = kony.sdk.getCurrentInstance().getObjectService(objectServiceName, options);
                        kony.sdk.mvvm.KonyApplicationContextMFAPP.OBJECT_SERVICES[optionsKey][objectServiceName] = objectService
                    }
        ...
        reset: function() {
            function destroyAllForms(scopeobj) {
                var frmObjs = scopeobj.formObjects ? scopeobj.formObjects.formObjArr : {};
                var buffer = new kony.sdk.mvvm.util.StringBuffer;
                for (var formId in frmObjs) {
                    frmObjs[formId]["konyformjsencoded"] = undefined;
                    if (frmObjs[formId]["konyform"] && typeof frmObjs[formId]["konyform"].destroy == "function") frmObjs[formId]["konyform"].destroy();
                    kony.sdk.mvvm.KonyGlobalObject[formId] = undefined;
                    buffer.append(formId + " = null;");
                    kony.sdk.mvvm.log.info("Initiating destroy of -- " + formId)
                }
                eval.call(null, buffer.toString())
            }
            this.sessionToken = undefined;
            destroyAllForms(this);
            this.metadataStore = undefined;
            this.formObjects = undefined
        },
        setApplicationProperties: function(appProperties) {
...
kony.sdk.mvvm.OfflineAuthenticationServiceManager = Class(kony.sdk.mvvm.BaseAuthenticationServiceManager, {
    ...
    getSavedUserDetails: function() {
        ...
        if (credentialObj) {
            var key = kony.sdk.mvvm.generateAndSaveKey("AFN");
            credentialObj[kony.sdk.mvvm.credStoreUsername] = credentialObj[kony.sdk.mvvm.credStoreUsername];
            credentialObj[kony.sdk.mvvm.credStorePassword] = credentialObj[kony.sdk.mvvm.credStorePassword]
        }
...
kony.sdk.mvvm.OfflineAuthenticationServiceManagerMF = Class(kony.sdk.mvvm.BaseAuthenticationServiceManager, {
    ...
    authenticate: function(params, successCallback, errorCallback) {
        ...
        try {
            ...
            if (credStore !== null && credStore !== undefined) {
                ...
                var storedAppType = credStore[kony.sdk.mvvm.credStoreAppType];
                var storedIdentityServiceName = credStore[kony.sdk.mvvm.credStoreIdentityService];
                if (kony.sdk.mvvm.Utils.matchIgnoreCase(storedUsername, username) && kony.sdk.mvvm.Utils.matchIgnoreCase(storedPassword, password) && kony.sdk.mvvm.Utils.matchIgnoreCase(storedOptions, options) && kony.sdk.mvvm.Utils.matchIgnoreCase(storedAppType, appType) && kony.sdk.mvvm.Utils.matchIgnoreCase(storedIdentityServiceName, identityServiceName)) {
                    var isAppSyncEnabled = storedOptions["access"] === "offline" ? true : false;
    ...
    saveUserDetails: function() {
        ...
        var key = kony.sdk.mvvm.generateAndSaveKey("UIRT");
        var encryptedUserName = kony.sdk.mvvm.encryptData(key, username);
        var encryptedPassword = kony.sdk.mvvm.encryptData(key, password);
        var storedDB = "";
        var storedCredStore = storeObj.getData(kony.sdk.mvvm.credStoreName);
    ...
    getSavedUserDetails: function() {
        ...
        if (credentialObj) {
            ...
            credentialObj[kony.sdk.mvvm.credStoreUsername] = credentialObj[kony.sdk.mvvm.credStoreUsername];
            credentialObj[kony.sdk.mvvm.credStorePassword] = credentialObj[kony.sdk.mvvm.credStorePassword];
            credentialObj[kony.sdk.mvvm.credStoreOptions] = credentialObj[kony.sdk.mvvm.credStoreOptions];
            credentialObj[kony.sdk.mvvm.credStoreAppType] = credentialObj[kony.sdk.mvvm.credStoreAppType];
            credentialObj[kony.sdk.mvvm.credStoreIdentityService] = credentialObj[kony.sdk.mvvm.credStoreIdentityService]
        }
        return credentialObj
    },
    execute: function(params, success, error) {
...
kony.sdk.mvvm.BaseFormControllerExtension = Class({
    constructor: function(controllerObj) {
        ...
        this.getGroupWidgetsContext = function() {
            if (!groupWidgetsContext) {
                var appFactoryInstance = controller.getApplicationContext().getFactorySharedInstance();
                groupWidgetsContext = appFactoryInstance.createGroupWidgetsContext(controller.getConfig(), controller.getContextData())
            }
                ...
                function setDataFromWidgets(widgets, modelObj, recordObject) {
                    ...
                    for (var widget in widgets) {
                        ...
                        if (fieldValue !== null && fieldValue !== undefined && fieldValue !== "") {
                            ...
                            var fieldType = modelObj.getValueForColumnProperty(aliasName, "type");
    ...
    fetchData: function(successCallback, errorCallback) {
        try {
            ...
            var scopeObj = this;
            var groupContext = appFactoryInstance.createGroupWidgetsContext(this.getController().getConfig(), this.getController().getContextData());
            this.setGroupWidgetsContext(groupContext);
            ...
            function fetchDataForWidgetGroup() {
                ...
                groupContext.fetchDataForGroupWidget(groupWidgets[indx], ormController, sucCallback, errCallback);

                function sucCallback(response) {
                    responseDataMap[groupWidgets[indx]] = response;
                    scopeObj.setContainerRecord(groupWidgets[indx], response);
                    indx++;
                    fetchDataForWidgetGroup()
                }
    ...
    processData: function(data) {
        var configWidgets = this.getController().getConfig().getWidgets();
        for (var widgetGroupId in data) {
            ...
            if (widgetResultProcessor) data[widgetGroupId] = widgetResultProcessor.process(data[widgetGroupId], widgetContext);
    ...
    saveData: function(successCallback, errorCallback) {
        try {
            ...
            if (dataMaplen >= 1) {
                ormController.saveRecords(recordsDataMap, sucCallback, errCallback)
            } else {
                return
            }
    ...
    deleteData: function(success, error) {
        try {
            ...
            var dataMaplen = recordsDataMap.length;
            if (dataMaplen >= 1) {
                ormController.removeRecords(recordsDataMap, sucCallback, errCallback)
            } else {
                return
            }

            function sucCallback(response) {
                success.call(scopeObj, response)
            }
    ...
    saveRecord: function(record, successCallback, errorCallback) {
        try {
            var scopeObj = this;
            var ormController = this.getORMController();
            ormController.saveRecord(record, sucCallback, errCallback);
    ...
    saveRecords: function(records, successCallback, errorCallback) {
        try {
            var scopeObj = this;
            var ormController = this.getORMController();
            ormController.saveRecords(records, sucCallback, errCallback);
...
kony.sdk.mvvm.BaseModel = Class({
    ...
    fetch: function(dataObject, onSuccess, onError) {
        ...
        try {
            ...
            self.getObjectService().fetch(options, success, error)
        } catch (e) {
            var exception;
    ...
    create: function(dataObject, onSuccess, onError) {
        try {
            var scopeObj = this;
            if (false === this.validate(dataObject, kony.sdk.mvvm.v2.Model.ValidationType.CREATE)) {
            ...
            scopeObj.getObjectService().create(options, success, error)
        } catch (e) {
    ...
    update: function(dataObject, onSuccess, onError) {
        ...
        try {
            var scopeObj = this;
            if (false === this.validate(dataObject, kony.sdk.mvvm.v2.Model.ValidationType.UPDATE)) {
            ...
            if (this.getAccessType() === "offline") scopeObj.getObjectService().update(options, success, error);
            else scopeObj.getObjectService().partialUpdate(options, success, error)
        } catch (err) {
    ...
    remove: function(dataObject, onSuccess, onError) {
        try {
            ...
            scopeObj.getObjectService().deleteRecord(options, success, error)
        } catch (err) {
...
kony.sdk.mvvm.HashBasedOfflineAuthentication = Class(kony.sdk.mvvm.OfflineAuthenticationServiceManager, {
    ...
    saveUserDetails: function() {
        ...
        var key = kony.sdk.mvvm.generateAndSaveKey("AFN");
        var encryptedUserName = kony.sdk.mvvm.encryptData(key, username);
        var encryptedPassword = kony.sdk.mvvm.encryptData(key, kony.crypto.createHash("SHA512", password));
        var storedDB = "";
        var storedCredStore = storeObj.getData(kony.sdk.mvvm.credStoreName);
        if (storedCredStore && storedCredStore[kony.sdk.mvvm.credStoreDb]) {
            storedDB = storedCredStore[kony.sdk.mvvm.credStoreDb]
    ...
    execute: function(params, success, error) {
        params["password"] = kony.crypto.createHash("SHA512", params["password"]);
        this.authenticate(params, success, error)
    }
});
...
kony.sdk.mvvm.MetadataServiceManagerMF = Class(kony.sdk.mvvm.AppInitServiceMangerInterface, {
    ...
    fetchForAllObjectServices: function(options, success, error) {
        ...
        function getAllObjectServicesFromSdk() {
            var objectServicesMapFromSdk = kony.sdk.getCurrentInstance().objectsvc;
...
kony.sdk.mvvm.persistent.ORMControllerMFAPP = Class(kony.sdk.mvvm.persistent.ORMControllerInterface, {
    ...
    fetchRecordByPrimaryKey: function(entityName, columnsdef, primaryFieldValueMap, serviceName, options, onSuccess, onError) {
        this.getORMController().fetchRecordByPrimaryKey(entityName, columnsdef, primaryFieldValueMap, serviceName, options, onSuccess, onError)
    },
    ...
    saveRecord: function(record, onSuccess, onError) {
        try {
            ...
            if (record.getInfo("remove")) {
                removeRecord(record, onSuccess, onError);
                return
            }
            ...
            if (operation && operation === kony.sdk.mvvm.OperationType.ADD) {
                ...
                entityCtrlr.create(model, success, error)
            }
    ...
    return {
        ...
        fetchByNativeQuery: function(entityName, query, serviceName, options, onSuccess, onError) {
            try {
                ...
                modelObj.fetch(dataObject, success, error);
        ...
        getFetchQueryMap: function(entityName, columnsdef, serviceName, options, parentReference) {
            try {
                ...
                throw scopeObj.getApplicationContext().getFactorySharedInstance().createExceptionObject(kony.sdk.mvvm.ExceptionCode.CD_ERROR_ORM_CONTROLLER_PREPARE_FETCH_QUERY, kony.sdk.mvvm.ExceptionCode.MSG_ERROR_ORM_CONTROLLER_PREPARE_FETCH_QUERY, e)
            }
        },
        fetchDataMap: function(queryMap, filter, serviceName, options, onSuccess, onError) {
            ...
            entityCtrlr.fetch(dataObject, success, error);
...
kony.sdk.mvvm.persistent.GroupWidgetsContext = Class({
    ...
    fetchDataForGroupWidget: function(widgetId, ORMController, successCallback, errorCallback) {
        var scopeObj = this;
        var widgetContext = this.getWidgetContext(widgetId);
        ...
        if (query && query.toLowerCase().indexOf("select") > -1) {
            ...
            ORMController.fetchRecordByPrimaryKey(entityName, columnsdef, dataModel.getPrimaryKeyValueMap(), serviceName, options, succCallback, errCallback)
        ...
        function succCallback(response) {
            if (response && response.length === 1) {
                scopeObj.updateChildWidgetsFilter(widgetContext, response[0], ORMController)
            }
            successCallback.call(scopeObj, response)
        }
    ...
    updateChildWidgetsFilter: function(widgetContext, resultRow, ORMController) {
        var entityName = widgetContext["entityName"];
        var serviceName = widgetContext["serviceName"];
        var options = widgetContext["options"];
...
kony.sdk.mvvm.SyncManagerMF = Class(kony.sdk.mvvm.AppInitServiceMangerInterface, {
    ...
    resetSyncIfNecessary: function(success, error, resetConfirmationHandler) {
        ...
        if (credStore !== null && credStore !== undefined) {
            ...
            var key = credStore[kony.sdk.mvvm.credStoreSecretKey];
            var storedOptions = credStore[kony.sdk.mvvm.credStoreOptions];
            var storedIdentityService = credStore[kony.sdk.mvvm.credStoreIdentityService];
            var storedUsername = credStore[kony.sdk.mvvm.credStoreUsername];
            if (storedUsername !== undefined && storedOptions !== undefined && storedIdentityService !== undefined && kony.sdk.mvvm.Utils.matchIgnoreCase(storedUsername, username) && kony.sdk.mvvm.Utils.matchIgnoreCase(storedOptions["access"], options["access"]) && kony.sdk.mvvm.Utils.matchIgnoreCase(storedIdentityService, identityServiceName)) {
                success()
            } else {
    ...
    manualSync: function(syncOptions, success, error) {
        try {
            ...
            var options = loginDetails["options"];
            var appType = loginDetails["APPTYPE"];
            var identityServiceName = loginDetails["identityServiceName"];
            var authParams = {
                username: username,
                password: password,
...
kony.sdk.mvvm.ExceptionCode = {
    ...
    MSG_ERROR_NOTIFYING_OBSERVERS: "Error notifying observers of viewmodel",
