...
$KW.VBox =
{
    ...
    {		
        ...
        var htmlString = ""; 
       // var boxstyle = /*$KW.Utils.getNormalImageStyle(vBoxModel) + */ " table-layout:fixed;" + $KW.skins.getMarginSkin(vBoxModel, context) + $KW.skins.getPaddingSkin(vBoxModel);	
            var boxstyle = /* $KW.Utils.getNormalImageStyle(boxModel) + */ " table-layout:fixed;" + $KW.skins.getBaseStyle(vBoxModel, context);
        ...
        else 
		{
            ...
            //var skinArray = $KW.skins.getSplitSkinsBetweenWidgetAndParentDiv(vBoxModel, context);
