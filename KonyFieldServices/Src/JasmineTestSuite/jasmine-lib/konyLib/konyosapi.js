...
/*
	Notes:
	var paramObj = {
	 {mixedscroll: {platforms: [{name:iphone, versions: [4], useragents:[]}, {name:android, versions: [-1], useragents:[]}]}},
	 {nativescroll: {platforms: [{name:iphone, versions: [4], useragents:[]}, {name:android, versions: [-1], useragents:[]}]}},
	} 
	setapplicationscrollmode(paramObj);
	OR
	
	{{mixedscroll: [{name:iphone, versions: [4], useragents:[]}, {name:android, versions: [-1], useragents:[]}]},
	 {nativescroll: [{name:iphone, versions: [4], useragents:[]}, {name:android, versions: [-1], useragents:[]}]},
	} 
	
	- A version of -1 indicates all versions of that platform
	- A user agent is independent of the version specified, useragent supersedes version
	- Custom is the default scroll mode and need not be explicitly specified; All which do not fall into mixed and native fall into custom
