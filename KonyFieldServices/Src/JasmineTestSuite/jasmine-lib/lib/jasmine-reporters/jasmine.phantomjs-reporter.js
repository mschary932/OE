(function() {
var Summary="",suitename="",totalsuites=0,totalcases=0,fails=0,skip=0;
    if (! jasmine) {
    ...
    PhantomJSReporter.prototype = {
        ...
        reportSpecResults: function(spec) {
            ...
            spec.output = '<testcase classname="' + this.getFullName(spec.suite) +
				...
				if(suitename!=this.getFullName(spec.suite))
				{
				suitename=this.getFullName(spec.suite);
				totalsuites++;
				Summary+="\n";
			Summary+="Test suite : "+this.getFullName(spec.suite)+ "";
			Summary+="\n";
			Summary+="\n";
			Summary+="  Test case : "+spec.description;
			Summary+="\n";
			totalcases++;
			}
			else
            ...
            for (var i = 0; i < resultItems.length; i++) {
				...
				{
				resultvalue="Fail -->"+result.message;
				fails++;
				}
				else
				{
        ...
        reportRunnerResults: function(runner) {
            ...
            for (var i = 0; i < suites.length; i++) {
                var suite = suites[i],
                    ...
                    //this.log(this.getFullName(suite, true));
			...
			this.log(Summary);
			this.log("Total Suites : "+ totalsuites + ",  Total Cases : "+ totalcases + ",  Failures : "+ fails +",  Skipped : "+skip)
