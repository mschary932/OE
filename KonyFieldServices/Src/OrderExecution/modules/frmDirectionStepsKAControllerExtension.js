 ...
 */
/*
 * bussiness/orchestration/mediation logic class for frmDirectionStepsKA.
 */
kony = kony || {};
kony.sdk = kony.sdk || {};
kony.sdk.mvvm = kony.sdk.mvvm || {};
kony.sdk.mvvm.v2 = kony.sdk.mvvm.v2 || {};
kony.sdk.mvvm.frmDirectionStepsKAControllerExtension = Class(kony.sdk.mvvm.CustomFormControllerExtensionMF, {
    ...
    bindData: function(dataMap) {
        try {
			...
			formmodel.clear();
		    formmodel.setViewAttributeByProperty("lblHeaderKA", "text", scopeObj.getFormModelInfo("directionStepsHeader"));
			formmodel.setViewAttributeByProperty("segDirectionStepsKA", "data", scopeObj.getFormModelInfo("directionStepsSegData"));
			formmodel.showView();         
        } catch (error) {
    ...
    showPreviousForm: function(doReload) {
		try {
			this.$class.$superp.showPreviousForm.call(this, doReload,"frmDirectionsKA");
		} catch(err) {
			kony.sdk.mvvm.log.error("error in Blogic showPreviousForm : " + err);
		}
	},
