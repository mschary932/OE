/*
 * FormModel class for frmExpenseDetailsKA
 ...
 * @class frmExpenseDetailsKAFormModel
 * @param {Object} controller - Form Controller.
 */
kony.sdk.mvvm.frmExpenseDetailsKAFormModel = Class(kony.sdk.mvvm.BaseFormModel, {
     ...
     * @memberof frmExpenseDetailsKAFormModel#
     */
    clear: function() {
