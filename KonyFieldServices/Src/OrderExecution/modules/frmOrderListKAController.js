/*
 * Controller class for frmOrderListKA
...
kony.sdk.mvvm.frmOrderListKAController = Class(kony.sdk.mvvm.BaseFormController, {
    /**
     * constructor method.
     */
    ...
    performAction: function(actionName, argsArray) {
		if( Object.keys(kony.servicesapp.swipedIndices).length > 0){
			...
			frmOrderListKA.segOrderListKA.animateRows({
				rows: [{
