 ...
 */
/*
 * bussiness/orchestration/mediation logic class for frmTimeAndExpenseAttachmentImageKA.
 */
kony = kony || {};
kony.sdk = kony.sdk || {};
kony.sdk.mvvm = kony.sdk.mvvm || {};
kony.sdk.mvvm.v2 = kony.sdk.mvvm.v2 || {};
kony.sdk.mvvm.frmTimeAndExpenseAttachmentImageKAControllerExtension = Class(kony.sdk.mvvm.CustomFormControllerExtensionMF, {
      ...
      try{
        ...
        this.$class.$superp.fetchData.call(this, success, errCallback);
      	...
      	function success(response){
              ...
              var controller = INSTANCE.getFormController("frmTimeAndExpenseAttachmentKA");
    ...
    navigateBack: function(){ 
	     try{ 
           	var formModel = this.getController().getFormModel();
        	formModel.setViewAttributeByProperty("BrowserImageKA","htmlString",null);
			this.$class.$superp.showPreviousForm.call(this,false,"frmTimeAndExpenseAttachmentKA");	    
         }        
         catch (err) {
