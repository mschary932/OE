...
kony.sdk.mvvm.frmDateFilterKAControllerExtension = Class(kony.sdk.mvvm.CustomFormControllerExtension, {
    $statics: {
        ...
        try {
           ...
           */
            ...
            if (flag) {
                ...
                var selectedDate = scopeObj.getFormModelInfo("DateFilter");
                scopeObj.selectDateFilter(selectedDateFilter, selectedDate);
            }
    ...
    clearFilters: function() {
        try {
            ...
            var viewApplied = controllerExtension.getFormModelInfo("ViewApplied");
            if (viewApplied && viewApplied == "Today") {
                formmodel.setViewAttributeByProperty("segDateFilterKA", "selectedRowIndex", [0, 0]);
            }
            controllerExtension.setFilterValue(0, "");
        } catch (err) {
