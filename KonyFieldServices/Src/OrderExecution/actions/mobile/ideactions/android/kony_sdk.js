...
kony.sdk.OfflineObjectService = function(konyRef, serviceName) {
     ...
     * @param {map} options - includes {"dataObject":(kony.sdk.dto.DataObject)}
    ...
    this.create = function(options, successCallback, failureCallback) {
        ...
        function createHandler(objMetadata) {
            ...
            recordObject.columnValues = kony.sdk.util.populateColumnValues(record, recordObject.childRecords);
    ...
    this.deleteRecord = function(options, successCallback, failureCallback) {
        ...
        function deleteHandler(objMetadata) {
            ...
            function delSuccCallback(result) {
                logger.log("### OfflineObjectService::delSuccCallback Response:" + JSON.stringify(result));
                var response = {};
                if (result !== null && result !== undefined && result.hasOwnProperty("deletedRecords")) {
            ...
            function delErrCallback(error) {
                logger.log("### OfflineObjectService::delErrCallback Error:" + JSON.stringify(error));
                kony.sdk.verifyAndCallClosure(failureCallback, error);
            }
        }
    };
    ...
    this.executeSelectQuery = function(queryStr, successCallback, failureCallback) {
        ...
        function selctSuccess(response) {
            logger.log("### OfflineObjectService::executeSelectQuery::selctSuccess Response:" + JSON.stringify(response));
            kony.sdk.verifyAndCallClosure(successCallback, response);
        }

        function selectError(error) {
            logger.log("### OfflineObjectService::executeSelectQuery::selctSuccess Error:" + JSON.stringify(error));
            kony.sdk.verifyAndCallClosure(failureCallback, error);
        }
    };
    /**
     * Helps to get the binary content of the specified column on the Object
     * @param {map} options - includes {"dataObject":(kony.sdk.dto.DataObject), "responsetype":"base64string/filepath(Default)", "binaryAttrName":columnName}
     * @param successCallback
     * @param failureCallback
     */
    this.getBinaryContent = function(options, successCallback, failureCallback) {
        ...
        function getBinaryDataHandler(objMetadata) {
            ...
            if (colMeta == null) {
                ...
                kony.sdk.verifyAndCallClosure(failureCallback, "Invalid binary attribute name.");
                return;
            }
            if (colMeta["datatype"] != kony.sdk.constants["binary"]) {
                ...
                kony.sdk.verifyAndCallClosure(failureCallback, "Datatype is not binary for the specified binary attribute name");
                return;
            }
    ...
    function _invokeOfflineChildCreate(recordObj, successCallback, failureCallback) {
        ...
        for (var i = 0; i < childRecordsCount; i++) {
            var tempRelationData = kony.sdk.util.getRelationOfEntity(objectRelations, childRecords[i].tableName);
            ...
            for (var tempIndex = 0; tempIndex < tempRelationshipFields.length; tempIndex++) {
                ...
                if (kony.sdk.util.isPrimaryKey(objectMetadata["primaryKey"], tempObj["referencingField"])) childColunValues[tempObj["referencedField"]] = parentColumns[tempObj["referencingField"]];
            }
            _invokeOfflineCreate(childRecords[i], childInsertSuccess, childInsertError)
        }

        function childInsertSuccess(result) {
            logger.log("### OfflineObjectService::offlineChildCreate::childInsertSuccess Response:" + JSON.stringify(result));
            count++;
            if (count == childRecordsCount) kony.sdk.verifyAndCallClosure(successCallback, result);
        }

        function childInsertError(error) {
            logger.log("### OfflineObjectService::offlineChildCreate::childInsertError Error:" + JSON.stringify(error));
            kony.sdk.verifyAndCallClosure(failureCallback, error);
        }
    }
    ...
    function _invokeOfflineCreate(recordObject, successCallback, failureCallback) {
        ...
        function insertsuccess(response) {
            if (recordObject.childRecords.length == 0) {
                logger.log("### OfflineObjectService::_invokeOfflineCreate::insertsuccess Response:" + JSON.stringify(response));
                kony.sdk.verifyAndCallClosure(successCallback, response);
            } else {
                ...
                _invokeOfflineChildCreate(recordObject, function(result) {
                    logger.log("### OfflineObjectService::_invokeOfflineCreate::insertsuccess Response:" + JSON.stringify(response));
                    kony.sdk.verifyAndCallClosure(successCallback, response);
                }, function(error) {
                    logger.log("### OfflineObjectService::_invokeOfflineCreate::insertsuccess Error:" + JSON.stringify(error));
                    kony.sdk.verifyAndCallClosure(failureCallback, error);
                })
            }
        }
        ...
        function inserterror(error) {
            logger.log("### OfflineObjectService::_invokeOfflineCreate::inserterror Error:" + JSON.stringify(error));
            kony.sdk.verifyAndCallClosure(failureCallback, error);
        }
    }
    ...
    function _invokeOffineChildUpdate(recordObj, successCallback, failureCallback) {
        ...
        var count = 0;
        for (var i = 0; i < childRecordsCount; i++) {
            _invokeOfflineUpdate(recordObj[i], childUpdateSuccess, childUpdateError)
        }

        function childUpdateSuccess(result) {
            logger.log("### OfflineObjectService::_invokeOffineChildUpdate::childUpdateSuccess Response:" + JSON.stringify(result));
            count++;
            if (count == childRecordsCount) kony.sdk.verifyAndCallClosure(successCallback, result);
        }

        function childUpdateError(error) {
            logger.log("### OfflineObjectService::_invokeOffineChildUpdate::childUpdateError Error:" + JSON.stringify(error));
            kony.sdk.verifyAndCallClosure(failureCallback, error);
        }
    }
    ...
    function _invokeOfflineUpdate(recordObject, successCallback, failureCallback) {
        ...
        function updateSuccess(response) {
            ...
            if (recordObject.childRecords.length == 0) {
                logger.log("### OfflineObjectService::_invokeOfflineUpdate::updateSuccess Response:" + JSON.stringify(response));
                kony.sdk.verifyAndCallClosure(successCallback, modifiedResponse);
            } else {
                _invokeOffineChildUpdate(recordObject.childRecords, function(result) {
                    logger.log("### OfflineObjectService::_invokeOfflineUpdate::updateSuccess Response:" + JSON.stringify(response));
                    kony.sdk.verifyAndCallClosure(successCallback, response);
                }, function(error) {
                    logger.log("### OfflineObjectService::_invokeOfflineUpdate::updateSuccess Error:" + JSON.stringify(error));
                    kony.sdk.verifyAndCallClosure(failureCallback, error);
                })
            }
        }
        ...
        function updateError(error) {
            logger.log("### OfflineObjectService::_invokeOfflineUpdate::updateError Error:" + JSON.stringify(error));
            kony.sdk.verifyAndCallClosure(failureCallback, error);
        }
    }
};
...
kony.sdk.OnlineObjectService = function(konyRef, serviceName) {
    ...
    /**
     * This method is used to create a record on the object
     * @param {map} options - includes {"dataObject":(kony.sdk.dto.DataObject),"headers":<map of http headers>}
     * @param successCallback
     * @param failureCallback
     */
    this.create = function(options, successCallback, failureCallback) {
    ...
    this.getDataUrl = function() {
        if (this.dataUrl == null) {
            this.dataUrl = stripTrailingCharacter(konyRef.objectsvc[serviceName]["url"], "/");
        }
        return this.dataUrl;
    };
    ...
    this.createBinaryContent = function(options, successCallback, failureCallback) {
        ...
        if (binaryColName == null || binaryColName == undefined) {
            ...
            kony.sdk.verifyAndCallClosure(failureCallback, "Please provide column name to create binary content");
            return;
        }

        function createBinaryContentOperationHandler() {
            currentObject.getMetadataOfObject(objName, {}, function(response) {
                _createUpdateBinaryContent(options, "createBinary", tmpDataUrl, successCallback, failureCallback);
            }, function(error) {
    ...
    this.updateBinaryContent = function(options, successCallback, failureCallback) {
        ...
        function updateBinaryContentOperationHandler() {
            currentObject.getMetadataOfObject(objName, {}, function(response) {
                _createUpdateBinaryContent(options, "updateBinary", tmpDataUrl, successCallback, failureCallback);
            }, function(error) {
    ...
    function _getBinaryContent(options, tmpDataUrl, successCallback, failureCallback) {
        ...
        if (objMetadata.primaryKey != undefined && objMetadata.primaryKey != null) {
            ...
            if (pkCount != 1) {
                kony.sdk.verifyAndCallClosure(failureCallback, "Provide only one primary condition to get Binary content.");
                return;
            }
            ...
            if (dataObject.getRecord()[pkey] == undefined || dataObject.getRecord()[pkey] == null) {
                ...
                kony.sdk.verifyAndCallClosure(failureCallback, "Please provide primary key details to get Binary content.");
                return;
            }
            url = url + "?operation=getBinary&FieldName=" + binaryColName + "&" + pkey + "=" + dataObject.getRecord()[pkey];
        } else {
            kony.sdk.verifyAndCallClosure(failureCallback, "Primary keys missing for the object:" + objName);
        }
        if (!headers) {
        ...
        headers["version"] = currentObject.getVersion();
    ...
    function _createUpdateBinaryContent(options, operation, tmpDataUrl, successCallback, failureCallback) {
        var dataObject = options["dataObject"];
        var headers = options["headers"];
        var binaryColName = options["binaryAttrName"];
        var objName = dataObject.getObjectName();
        ...
        if (objMetadata.primaryKey != undefined && objMetadata.primaryKey != null) {
            var pkCount = objMetadata.primaryKey.length;
            if (pkCount != 1) {
                kony.sdk.verifyAndCallClosure(failureCallback, "Provide only one primary condition to create Binary content.");
                return;
            }
            //reading primarykey and framing filter clause
            pkey = objMetadata.primaryKey[0];
            if (dataObject.getRecord()[pkey] == undefined || dataObject.getRecord()[pkey] == null) {
                logger.log("### OnlineObjectService::_createUpdateBinaryContent Error: Please provide primary key details to create Binary content.");
                kony.sdk.verifyAndCallClosure(failureCallback, "Please provide primary key details to create Binary content.");
                return;
            }
            jsonPayload[pkey] = dataObject.getRecord()[pkey];
            jsonPayload["FieldValue"] = dataObject.getRecord()[binaryColName];
        } else {
            kony.sdk.verifyAndCallClosure(failureCallback, "Primary keys missing for the object:" + objName);
        }
        if (!headers) {
        ...
        function invokeSuccessCallback(response) {
            logger.log("### OnlineObjectService::__createUpdateBinaryContent::invokeSuccessCallback Response:" + JSON.stringify(response));
            kony.sdk.verifyAndCallClosure(successCallback, response[pkey]);
        }

        function invokeFailureCallback(error) {
            logger.log("### OnlineObjectService::_createUpdateBinaryContent::invokeFailureCallback Error:" + JSON.stringify(error));
            kony.sdk.verifyAndCallClosure(failureCallback, error);
        }
    };
    ...
    function _create(options, tmpDataUrl, successCallback, failureCallback) {
        ...
        headers["version"] = currentObject.getVersion();
        var formData = new kony.net.FormData();
        formData.append("jsondata", JSON.stringify(dataObject.getRecord()));
    ...
    if (srcAttributes != null && srcAttributes != undefined) {
        ...
        for (var indx = 0; indx < pkLen; indx++) {
            ...
            if (pKeyValue == null || pKeyValue == undefined) {
                //TODO
                //throw error
                kony.sdk.logger.log("### kony.sdk.util.deleteRecordCascade:: Error Primarykey details missing so unable to delete");
...
kony.sdk.util.cascadeDelete = function(serviceName, tx, targetObjectName, wcs, errorcallback, markForUpload, isCascade, parentTable, isLocal) {
    ...
    if (tmpSrcAttributes == null || tmpSrcAttributes == undefined || tmpSrcAttributes.length == 0) {
        //TODO
        //throw error
        kony.sdk.logger.log("### kony.sdk.util.cascadeDelete:: Error: Primarykey details missing so unable to delete records from:" + tbname);
...
function IntegrationService(konyRef, serviceName) {
    ...
    function _invokeOperation(operationName, headers, data, successCallback, failureCallback) {
        ...
        if (typeof(svcObj) === 'object' && svcObj.version) {
            defaultHeaders["version"] = svcObj.version;
        }
        // if the user has defined his own headers, use them
        if (headers) {
            for (var header in headers) {
...
kony.setupsdks = function(initConfig, successCallBack, errorCallBack) {
    ...
    var sdkInit = function(initConfig, successcallback, failurecallback) {
            initConfig.appKey = "d82cc933be306e938954992a09a2f281";
            initConfig.appSecret = "97425f84ef8cd68766648601ec371317";
            initConfig.serviceUrl = "http://appsqa.konylabs.net:80/authService/100000002/appconfig";
            initConfig.isMFApp = true;
            ...
            if (!kony.sdk.isNetworkAvailable() && initConfig && initConfig.appConfig) {
                ...
                if (svcDocStr) initConfig.appConfig.svcDoc = JSON.parse(svcDocStr);
                else failurecallback(kony.sdk.error.getMFcodeErrObj(kony.sdk.errorcodes.servicedoc_unavailable, kony.sdk.errormessages.servicedoc_unavailable));
            }
