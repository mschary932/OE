...
<%
	...
	KonyServerWidget widgetInfo = (KonyServerWidget)((LuaTable)uiState.get(formid)).map.get(widgetid);
	Boolean isVisible =  (Boolean)widgetInfo.map.get(constants.ISVISIBLE);
