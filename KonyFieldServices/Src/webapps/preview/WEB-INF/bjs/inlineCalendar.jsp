...
<%if(formatItem.equals("dd")){%>
	...
	<%}else{%>
		<td style="width:14%;">
	<%}%>
            <select id="<%=dl%>"  name="<%=dl%>" konywidgettype="KcalendarInline" <%=widget.map.get(WEBConstants.ENABLED) %> style="width:100%;">
...
<%}else if(formatItem.equals("yyyy")){%>
        <td style="width:40%;">
            <select id="<%=yl%>" name="<%=yl%>" konywidgettype="KcalendarInline" <%=widget.map.get(WEBConstants.ENABLED) %> style="width:100%;">
