...
<%
	...
	String gpath = null; String webprotocol = null;
	...
	String deviceCategory = WEBConstants.XHTML_BASICJS_MARKUP;
    ...
    if(widget == null && form != null && widgetId != null)
    {
    	widget = (KonyServerWidget)form.map.get(widgetId);
    }
    ...
    String style = "";
    String containereventName = null;
    if(request.getAttribute("containerevent") != null)
    {
       containereventName = request.getAttribute("containerevent").toString();
    }
%>