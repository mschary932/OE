...
<div id="<%=widgetid%>" konywidgettype="KTouchimggal" eventname="<%=widgetid%>.div.event_.Kimggal" >
    ...
    <%  
        ...
        if (obj != null)
        {
               ...
               if(widget.map.get("heightwidth")!= null){
    ...
    <%
		...
		%>		
                    <div  class=" kcell"  valign="middle" align="center">
                        <% if(widget.map.get("heightwidth")!= null && !widget.map.get("heightwidth").equals("0,0")){%>
                            <img src="<%=img%> " class="<%=imgSkin%>" konywidgettype = "Kimggal" eventname="<%=String.format("%s.%d.event_.Kimggal",widget.map.get("id"),i)%>"
                                 ...
                                 margin-left:<%=image_left_space%>px;
                                  width:<%=dim[0]%>px; height:<%=dim[1]%>px;"
