...
<%String segmentid = (String)request.getAttribute("segmentid");
        ...
        if(segmentid != null && ("Button".equals(wtype) || "Line".equals(wtype) || "Link".equals(wtype) || "Label".equals(wtype) || "Image".equals(wtype) || "RichText".equals(wtype) || "Phone".equals(wtype) || "Image2".equals(wtype)) )
        {  
