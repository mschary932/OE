    ...
    if (isVisible)
    {
        ...
        if (obj != LuaNil.nil)
        {
            ...
            if (obj != LuaNil.nil && obj instanceof java.util.Hashtable)
            {
                ...
                if (widget.getTable(constants.SECTION_HEADER_SKIN) != null && widget.getTable(constants.SECTION_HEADER_SKIN) != LuaNil.nil) {
                ...
                if(KonySegmentUI.VIEW_TYPE_PAGE.equals(widget.map.get(constants.VIEW_TYPE)) || "pageview".equals(widget.map.get("view")))
                {
                 ...
                 <%if(widget.getTable(constants.FOCUSED_INDEX) != LuaNil.nil)
                       {
                            i = Double.valueOf(widget.getTable(constants.FOCUSED_INDEX).toString()).intValue();
                       }
