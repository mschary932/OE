...
//images, map style, inputURL
            ...
            String wid = (String) widget.map.get("id");
            ...
            if(widget.map.get("bjs"+imageCat+"mapHeight")!= null && !"0".equals(widget.map.get("bjs"+imageCat+"mapHeight")))
            {
                height = (String)widget.map.get("bjs"+imageCat+"mapHeight");
                fixedsize = true;
            }
            if(widget.map.get("bjs"+imageCat+"mapWidth")!= null && !"0".equals(widget.map.get("bjs"+imageCat+"mapWidth")))
            {
                width = (String)widget.map.get("bjs"+imageCat+"mapWidth");
                fixedsize = true;
            } 
%>
...
<img src="<%=webprotocol + mapURL%>"      alt="Map Widget"  <%if(fixedsize) { %> style =" width:<%=width%>px; height:<%=height%>px;" <%} else {%>
     style="width: <%=JSWAPUtil.adjustedWeightForMargin(widget, "100")%>;"
     <%} %>/>
