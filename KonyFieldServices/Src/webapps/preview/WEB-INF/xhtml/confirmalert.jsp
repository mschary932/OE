...
<form id="konyalert" action="<%=apppath%>" method="post" class="<%=webAlert.alertSkin%>">
    ...
    <%}%>
    <input type="submit" name="alert_confirm_yes" value="<%=webAlert.yesLabel%>" title="<%=webAlert.yesLabel%>"/>
    <input type="submit" name="alert_confirm_no" value="<%=webAlert.noLabel%>" title="<%=webAlert.noLabel%>"/>
</form>
</body>
</html>