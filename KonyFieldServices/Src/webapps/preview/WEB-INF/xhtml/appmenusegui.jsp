...
if (request.getScheme().equalsIgnoreCase("https")) {
 ...
 gpath = upath;
  ...
  String imgpath = gpath + "/xhtml/images/";
...
<link href="<%=gpath + "/xhtml"+  WEBUtil.getTheme() + "/konybasicxhtml" + imageCat +".css"%>" rel="stylesheet" type="text/css" />

</head>
<body>
<form id="appmenusegui" action="<%=apppath%>/appmenusegui" method="post">
<input name="formid" type="hidden" value="appmenusegui"/>
<input name="cat" type="hidden" value="basic"/>
