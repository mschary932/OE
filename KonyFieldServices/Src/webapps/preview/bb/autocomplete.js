kony.widgets.TextField.AutoComplete = {
    /**
    * Global vars
    */
	__AutoCompleteClass : 'autocomplete',
    ...
    */
    AutoComplete_Create:function(id, data){
        ...
        this.__AutoComplete[id]['element'].onkeydown  = function(e) {return kony.widgets.TextField.AutoComplete.AutoComplete_KeyDown(this.getAttribute('id'), e);}
        this.__AutoComplete[id]['element'].onkeyup    = function(e) {return kony.widgets.TextField.AutoComplete.AutoComplete_KeyUp(this.getAttribute('id'), e);}
        this.__AutoComplete[id]['element'].onkeypress = function(e) {if (!e) e = window.event; if (e.keyCode == 13 || this.isOpera) return false;}
        this.__AutoComplete[id]['element'].ondblclick = function() {kony.widgets.TextField.AutoComplete.AutoComplete_ShowDropdown(this.getAttribute('id'));}
        ...
        {
		   this.__AutoComplete = kony.widgets.TextField.AutoComplete.__AutoComplete;
           for (id in this.__AutoComplete) {
               kony.widgets.TextField.AutoComplete.AutoComplete_HideDropdown(id);
           }
        }
        ...
        if (this.isIE) {
			var iframeExists = document.getElementById(id+'_iframe'); 
			if(iframeExists)
				iframeExists.parentNode.removeChild(iframeExists);
   ...
   //alert(left)
		...
		kony.widgets.TextField.AutoComplete.AutoComplete_RemoveDivs(id);
    ...
    */
    AutoComplete_ShowDropdown:function(id)
    {
        ...
        for (i=0; i<toDisplay.length; ++i) {
            ...
            newDiv.onmouseover = function() {kony.widgets.TextField.AutoComplete.AutoComplete_HighlightItem(kony.widgets.TextField.AutoComplete.__AutoComplete[id]['element'].getAttribute('id'), this.getAttribute('index'));};
            newDiv.onclick     = function() {kony.widgets.TextField.AutoComplete.AutoComplete_SetValue(kony.widgets.TextField.AutoComplete.__AutoComplete[id]['element'].getAttribute('id')); kony.widgets.TextField.AutoComplete.AutoComplete_RemoveDivs(id);}
