...
public class TestFormMeasurementAttachmentKA extends OrderExecutionBaseTest {

	@BeforeMethod
	public void setupBeforeTest() throws Exception{
		AppElement ele = null;
		try {
			 ele = new AppElement(OrderExecutionWidgetId.getWidgetId("frmOrderAttachmentsKA_lblOrderAttachmentsKA"));
		} catch (Exception e) {
			if (ele == null){
...
//					frmLoginKA =  new FormLogInKA();//							
				...
				System.out.println("TestFormMeasurementAttachmentKA.setupBeforeTest(): Not on the Order Execution Form");
    ...
    FormMeasurementAttachmentKA mesurementExecutionForm = new FormMeasurementAttachmentKA();	
